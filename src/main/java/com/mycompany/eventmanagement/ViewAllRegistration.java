 ...
 * @author My PC
 */
public class ViewAllRegistration extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            ArrayList<RegistrationDetail> listregistration=repo.registrationDetails();
            request.setAttribute("listregisteration",listregistration);
            RequestDispatcher rd=request.getRequestDispatcher("jspPages/ViewRegistrations.jsp");
            rd.forward(request, response);
        }
        catch(Exception e){
